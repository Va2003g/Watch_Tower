...
for (var i = 0; i < menData.length; i++) {
  let temp = `<div class="product-box" id=${menData[i].image}>
...
for (var i = 0; i < womenData.length; i++) {
  let temp = `<div class="product-box" id=${womenData[i].image}>
...
for (var i = 0; i < womenData.length; i++) {
  ...
  let temp = `<div class="product-box" id=${kidsData[i].image}>
    <img src="./images/${
      kidsData[i].image
...
extension = "jpeg";
for (var i = 0; i < womenData.length; i++) {
  let temp = `<div class="product-box" id=${wallData[i].image}>
    <img src="./images/${
      wallData[i].image
    }.${extension}" alt="" class="product-img">
